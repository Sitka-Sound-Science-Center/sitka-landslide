...
!(function (t, n) {
	...
	function I(t, n, e) {
		var r = (n - t) / Math.max(0, e),
			...
			o = r / Math.pow(10, i);
		return i >= 0
			? (o >= F ? 10 : o >= q ? 5 : o >= O ? 2 : 1) * Math.pow(10, i)
			: -Math.pow(10, -i) / (o >= F ? 10 : o >= q ? 5 : o >= O ? 2 : 1);
	}
	function B(t, n, e) {
		...
		return (
			(r.value = function (n) {
				return arguments.length
					? ((t = "function" == typeof n ? n : R(n)), r)
					: t;
			}),
			(r.domain = function (t) {
				return arguments.length
					? ((n = "function" == typeof t ? t : R([t[0], t[1]])), r)
					: n;
			}),
	...
	function Ye(t) {
		...
		return (
			r === i && i === o
				? (n = e = a)
				: ((n = He((0.4360747 * r + 0.3850649 * i + 0.1430804 * o) / qe)),
		...
		function h(e) {
			if ((!n || e.touches) && r.apply(this, arguments)) {
				...
				if ("overlay" === b) {
					...
					(M.selection = T =
						[
							[
								(i = t === Bo ? S : qo(n[0][0], n[1][0])),
								(u = t === Io ? E : qo(n[0][1], n[1][1])),
							],
							[
								(l = t === Bo ? k : Fo(n[0][0], n[1][0])),
								(d = t === Io ? N : Fo(n[0][1], n[1][1])),
							],
						]),
						D.length > 1 && I(e);
			...
			function I(t) {
				...
				switch (((C = n[0] - e[0]), (P = n[1] - e[1]), m)) {
					case Po:
					case Co:
						x && ((C = Fo(S - i, qo(k - l, C))), (a = i + C), (h = l + C)),
							w && ((P = Fo(E - u, qo(N - d, P))), (c = u + P), (p = d + P));
						break;
					case zo:
						D[1]
							? (x &&
							  ...
							  w &&
									...
									(w = 1)))
							: (x < 0
									? ((C = Fo(S - i, qo(k - i, C))), (a = i + C), (h = l))
									: x > 0 &&
									  ((C = Fo(S - l, qo(k - l, C))), (a = i), (h = l + C)),
							  w < 0
									? ((P = Fo(E - u, qo(N - u, P))), (c = u + P), (p = d))
									: w > 0 &&
									  ((P = Fo(E - d, qo(N - d, P))), (c = u), (p = d + P)));
						break;
					case Do:
						x && ((a = Fo(S, qo(k, i - C * x))), (h = Fo(S, qo(k, l + C * x)))),
							w &&
								((c = Fo(E, qo(N, u - P * w))), (p = Fo(E, qo(N, d + P * w))));
				}
				h < a &&
					((x *= -1),
					(r = i),
	...
	function Ds(t, n, e, r, i, o) {
		if (e) {
			...
			for (var f, s = i; r > 0 ? s > o : s < o; s -= c)
				(f = Rf([a, -u * Hc(s), -u * Zc(s)])), t.point(f[0], f[1]);
		}
	}
	function Rs(t, n) {
		((n = Ff(n))[0] -= t), Bf(n);
	...
	function Hs(t, n) {
		return (
			((t = t.x)[0] < 0 ? t[1] - qc - Dc : qc - t[1]) -
			((n = n.x)[0] < 0 ? n[1] - qc - Dc : qc - n[1])
		);
	}
	Es.invert = Es;
	var Xs = Ls(
			...
			if ((a = t._squarify) && a.ratio === n)
				for (var a, u, c, f, s, l = -1, h = a.length, d = t.value; ++l < h; ) {
					...
					u.dice
						...
						: Kd(u, e, r, d ? (e += ((i - e) * u.value) / d) : i, o),
						(d -= u.value);
				}
	...
	function Rp(t, n, e) {
		var r = t[0],
			...
			a = n[1];
		return (
			i < r ? ((r = Dp(i, r)), (o = e(a, o))) : ((r = Dp(r, i)), (o = e(o, a))),
			function (t) {
				return o(r(t));
			}
		);
	...
	function $p(n) {
		...
		function u() {
			return (
				...
				r()[0] < 0 ? ((i = Vp(i)), (o = Vp(o)), n(Hp, Xp)) : n(Lp, jp),
				e
			);
		}
		return (
	...
	function ng(t) {
		var n = t(zp, zp),
			e = 1;
		function r() {
			return 1 === e ? t(zp, zp) : 0.5 === e ? t(Jp, tg) : t(Qp(e), Qp(1 / e));
		}
		return (
		...
		return (
			...
			e &&
				((i.count = function (n, r) {
					return (
						og.setTime(+n), ag.setTime(+r), t(og), t(ag), Math.floor(e(og, ag))
					);
				}),
				(i.every = function (t) {
					return (
	...
	var _g = ug(
		...
		Ag = ug(
			function (t) {
				t.setTime(
					t - t.getMilliseconds() - t.getSeconds() * lg - t.getMinutes() * hg
				);
			},
			function (t, n) {
				t.setTime(+t + n * dg);
		...
		Eg = ug(
			...
			(t, n) =>
				(n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * hg) / pg,
			(t) => t.getDate() - 1
		),
		kg = Eg,
		Ng = Eg.range;
	function Cg(t) {
		return ug(
			...
			function (t, n) {
				return (
					(n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * hg) / gg
				);
			}
		);
	}
		...
		function M(t, n) {
			return function (e) {
				...
				if (
					...
					"w" in o || (o.w = 1),
						"Z" in o
							? ((i = (r = Dy(Ry(o.y, 0, 1))).getUTCDay()),
							  (r = i > 4 || 0 === i ? cy.ceil(r) : cy(r)),
							  (r = iy.offset(r, 7 * (o.V - 1))),
							  (o.y = r.getUTCFullYear()),
							  (o.m = r.getUTCMonth()),
							  (o.d = r.getUTCDate() + ((o.w + 6) % 7)))
							: ((i = (r = zy(Ry(o.y, 0, 1))).getDay()),
							  (r = i > 4 || 0 === i ? zg.ceil(r) : zg(r)),
							  (r = kg.offset(r, 7 * (o.V - 1))),
							  (o.y = r.getFullYear()),
							  (o.m = r.getMonth()),
							  (o.d = r.getDate() + ((o.w + 6) % 7)));
				} else ("W" in o || "U" in o) && ("w" in o || (o.w = "u" in o ? o.u % 7 : "W" in o ? 1 : 0), (i = "Z" in o ? Dy(Ry(o.y, 0, 1)).getUTCDay() : zy(Ry(o.y, 0, 1)).getDay()), (o.m = 0), (o.d = "W" in o ? ((o.w + 6) % 7) + 7 * o.W - ((i + 5) % 7) : o.w + 7 * o.U - ((i + 6) % 7)));
				return "Z" in o
					? ((o.H += (o.Z / 100) | 0), (o.M += o.Z % 100), Dy(o))
					: zy(o);
			};
		}
		function A(t, n, e, r) {
	...
	function Mv(t, n) {
		return (t = wv(t)), Yy(Fg.count(Wg(t), t) + (4 === Wg(t).getDay()), n, 2);
	}
	function Av(t) {
		return t.getDay();
	}
	...
	function jv(t, n) {
		return (
			(t = Lv(t)), Yy(ly.count(Ty(t), t) + (4 === Ty(t).getUTCDay()), n, 2)
		);
	}
	function Hv(t) {
		return t.getUTCDay();
	...
	function Wv(t, n) {
		var e = t.getUTCDay();
		return Yy(
			(t = e >= 4 || 0 === e ? ly(t) : ly.ceil(t)).getUTCFullYear() % 1e4,
			n,
			4
		);
	}
	...
	var e_ = Date.prototype.toISOString
			...
			: t.utcFormat(n_),
		r_ = e_;
	var i_ = +new Date("2000-01-01T00:00:00.000Z")
			? function (t) {
					var n = new Date(t);
	...
	var g_ = p_("1f77b4ff7f0e2ca02cd627289467bd8c564be377c27f7f7fbcbd2217becf"),
		...
		Ab = new Array(3)
			...
			.map(p_),
		Tb = T_(Ab);
	var Sb = Wr(ur(300, 0.5, 0), ur(-240, 0.5, 1)),
		Eb = Wr(ur(-100, 0.75, 0.35), ur(80, 1.5, 0.8)),
		kb = Wr(ur(260, 0.75, 0.35), ur(80, 1.5, 0.8)),
		Nb = ur();
	var Cb = Ae(),
		Pb = Math.PI / 3,
		zb = (2 * Math.PI) / 3;
	...
	function lm(t, n) {
		...
		return (
			(t = "function" == typeof t ? t : void 0 === t ? fm : Ub(t)),
			(n = "function" == typeof n ? n : void 0 === n ? sm : Ub(n)),
			(a.x = function (n) {
				return arguments.length
					? ((t = "function" == typeof n ? n : Ub(+n)), a)
					: t;
			}),
			(a.y = function (t) {
				return arguments.length
					? ((n = "function" == typeof t ? t : Ub(+t)), a)
					: n;
			}),
			(a.defined = function (t) {
				return arguments.length
					? ((e = "function" == typeof t ? t : Ub(!!t)), a)
					: e;
			}),
			(a.curve = function (t) {
	...
	function hm(t, n, e) {
		...
		return (
			...
			(c.x = function (n) {
				return arguments.length
					? ((t = "function" == typeof n ? n : Ub(+n)), (r = null), c)
					: t;
			}),
			(c.x0 = function (n) {
				return arguments.length
					? ((t = "function" == typeof n ? n : Ub(+n)), c)
					: t;
			}),
			(c.x1 = function (t) {
				return arguments.length
					? ((r = null == t ? null : "function" == typeof t ? t : Ub(+t)), c)
					: r;
			}),
			(c.y = function (t) {
				return arguments.length
					? ((n = "function" == typeof t ? t : Ub(+t)), (e = null), c)
					: n;
			}),
			(c.y0 = function (t) {
				return arguments.length
					? ((n = "function" == typeof t ? t : Ub(+t)), c)
					: n;
			}),
			(c.y1 = function (t) {
				return arguments.length
					? ((e = null == t ? null : "function" == typeof t ? t : Ub(+t)), c)
					: e;
			}),
			(c.lineX0 = c.lineY0 =
				function () {
	...
	function Nm(t) {
		...
		return (
			...
			(u.x = function (t) {
				return arguments.length
					? ((r = "function" == typeof t ? t : Ub(+t)), u)
					: r;
			}),
			(u.y = function (t) {
				return arguments.length
					? ((i = "function" == typeof t ? t : Ub(+t)), u)
					: i;
			}),
	...
	var Pm = {
			draw(t, n) {
				const e = 0.59436 * Xb(n + jb(n / 28, 0.75)),
					r = e / 2,
					i = r * Cm;
				t.moveTo(0, e),
					t.lineTo(0, -e),
	...
	var Hm = {
		draw(t, n) {
			const e = Xb(0.8908130915292852 * n),
				r = Lm * e,
				i = jm * e;
	...
	var Jm = {
		...
		tx = {
			draw(t, n) {
				const e = 0.6189 * Xb(n - jb(n / 6, 1.7));
	...
	function cx(t, n) {
		(this._basis = new ox(t)), (this._beta = n);
	}
	(ox.prototype = {
		areaStart: function () {
			this._line = 0;
	...
	function Sx(t, n, e) {
		var r = t._x1 - t._x0,
			...
			u = (o * i + a * r) / (r + i);
		return (
			(Tx(o) + Tx(a)) * Math.min(Math.abs(o), Math.abs(a), 0.5 * Math.abs(u)) ||
			0
		);
	}
	function Ex(t, n) {
				...
				if (((n = +n), (t = +t) !== this._x1 || n !== this._y1)) {
					switch (this._point) {
						...
						case 1:
							...
							break;
						case 2:
							(this._point = 3), kx(this, Ex(this, (e = Sx(this, t, n))), e);
							break;
						default:
			...
			lineEnd: function () {
				...
				if (e)
					if (
						...
						for (var r = Dx(t), i = Dx(n), o = 0, a = 1; a < e; ++o, ++a)
							this._context.bezierCurveTo(
								r[0][o],
								i[0][o],
								r[1][o],
	...
	Xx.prototype = {
		...
		translate: function (t, n) {
			return (0 === t) & (0 === n)
				? this
				: new Xx(this.k, this.x + this.k * t, this.y + this.k * n);
		},
		apply: function (t) {
	...
	(Vx.prototype = Xx.prototype),
		...
		(t.arc = function () {
				...
				if ((u || (u = c = ya()), l < s && ((f = l), (l = s), (s = f)), l > Gb))
					if (p > Wb - Gb)
						u.moveTo(l * Yb(h), l * Hb(h)),
							u.arc(0, 0, l, h, d, !g),
							s > Gb &&
								(u.moveTo(s * Yb(d), s * Hb(d)), u.arc(0, 0, s, d, h, g));
					else {
						var y,
							v,
							_ = h,
								  ...
								  k < S
										...
										: (u.arc(
										  ...
										  u.arc(
												...
												0,
												l,
												Bb(y.cy + y.y11, y.cx + y.x11),
												Bb(v.cy + v.y11, v.cx + v.x11),
												!g
										  ),
										  u.arc(
												v.cx,
			...
			return (
				...
				(c.endAngle = function (t) {
					return arguments.length
						? ((o = "function" == typeof t ? t : Ub(+t)), c)
						: o;
				}),
				(c.padAngle = function (t) {
					return arguments.length
						? ((a = "function" == typeof t ? t : Ub(+t)), c)
						: a;
				}),
				(c.context = function (t) {
		...
		(t.geoAlbersUsa = function () {
			var t,
				...
				o,
				a = Oh(),
				u = qh().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]),
				c = qh().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]),
				f = {
					point: function (t, n) {
						o = [t, n];
					},
		...
		(t.pack = function () {
			...
			function i(i) {
				return (
					...
					(i.y = e / 2),
					t
						? i.eachBefore(Dd(t)).eachAfter(Rd(r, 0.5)).eachBefore(Fd(1))
						: i
								.eachBefore(Dd(zd))
								.eachAfter(Rd(Cd, 1))
								.eachAfter(Rd(r, i.r / Math.min(n, e)))
								.eachBefore(Fd(Math.min(n, e) / (2 * i.r))),
					i
				);
			}
			return (
		...
		(t.pie = function () {
			...
			return (
				...
				(a.startAngle = function (t) {
					return arguments.length
						? ((r = "function" == typeof t ? t : Ub(+t)), a)
						: r;
				}),
				(a.endAngle = function (t) {
					return arguments.length
						? ((i = "function" == typeof t ? t : Ub(+t)), a)
						: i;
				}),
				(a.padAngle = function (t) {
					return arguments.length
						? ((o = "function" == typeof t ? t : Ub(+t)), a)
						: o;
				}),
				a
			);
		...
		(t.polygonHull = function (t) {
			...
			for (r.sort(rp), n = 0; n < e; ++n) i[n] = [r[n][0], -r[n][1]];
			var o = ip(r),
				a = ip(i),
				u = a[0] === o[0],
		...
		(t.scaleDivergingSqrt = function () {
			return d_.apply(null, arguments).exponent(0.5);
		}),
		...
		(t.scaleLog = function t() {
			...
			return (
				(n.copy = () => qp(n, t()).base(n.base())), Ap.apply(n, arguments), n
			);
		}),
		(t.scaleOrdinal = Ep),
		...
		(t.scaleRadial = function t() {
			...
			return (
				...
				(o.range = function (t) {
					return arguments.length
						? (e.range((r = Array.from(t, Cp)).map(rg)), o)
						: r.slice();
				}),
		...
		(t.scaleTime = function () {
			return Ap.apply(
				c_(Cy, Py, Wg, Gg, Pg, kg, Tg, wg, bg, t.timeFormat).domain([
					new Date(2e3, 0, 1),
					new Date(2e3, 0, 2),
				]),
				arguments
		...
		(t.scaleUtc = function () {
			return Ap.apply(
				c_(ky, Ny, Ty, wy, uy, iy, ny, Qg, bg, t.utcFormat).domain([
					Date.UTC(2e3, 0, 1),
					Date.UTC(2e3, 0, 2),
				]),
				arguments
		...
		(t.stack = function () {
			...
			function i(i) {
				var o,
					a,
					u = Array.from(t.apply(this, arguments), Ux),
					c = u.length,
					f = -1;
				for (const t of i)
					for (o = 0, ++f; o < c; ++o)
						(u[o][f] = [0, +r(t, u[o].key, f, i)]).data = t;
				for (o = 0, a = am(n(u)); o < c; ++o) u[a[o]].index = o;
				return e(u, a), u;
			}
			return (
				(i.keys = function (n) {
					return arguments.length
						? ((t = "function" == typeof n ? n : Ub(Array.from(n))), i)
						: t;
				}),
				(i.value = function (t) {
					return arguments.length
						? ((r = "function" == typeof t ? t : Ub(+t)), i)
						: r;
				}),
				(i.order = function (t) {
					return arguments.length
				...
				(i.offset = function (t) {
					return arguments.length ? ((e = null == t ? Fx : t), i) : e;
				}),
				i
			);
		}),
			...
			function r(r) {
				...
				if (null != t) {
					const n = h.map((n, e) =>
						...
						i = new Set(n).add("");
					for (const t of e)
						i.has(t) || (i.add(t), n.push(t), e.push(jd(t)), h.push(Bd));
					(d = (t, e) => n[e]), (p = (t, n) => e[n]);
				}
				...
				if (null != t) {
					for (; u.data === Bd && 1 === u.children.length; )
						(u = u.children[0]), --i;
					for (let t = h.length - 1; t >= 0 && ((f = h[t]), f.data === Bd); --t)
						f.data = null;
				}
				if (
					((u.parent = Ud),
		...
		(t.symbol = function (t, n) {
			...
			return (
				(t = "function" == typeof t ? t : Ub(t || zm)),
				(n = "function" == typeof n ? n : Ub(void 0 === n ? 64 : +n)),
				(r.type = function (n) {
					return arguments.length
						? ((t = "function" == typeof n ? n : Ub(n)), r)
						: t;
				}),
				(r.size = function (t) {
					return arguments.length
						? ((n = "function" == typeof t ? t : Ub(+t)), r)
						: n;
				}),
						...
						for (
							...
							(c = Gd(c)),
								...
								(i = u.z + l - o.z - f + t(u._, o._)) > 0 &&
									($d(Wd(u, n, r), n, i), (f += i), (s += i)),
								(l += u.m),
								(f += o.m),
								(h += c.m),
								(s += a.m);
						u && !Vd(a) && ((a.t = u), (a.m += l - s)),
		...
		(t.zoom = function () {
			...
			return (
				...
				(y.wheelDelta = function (t) {
					return arguments.length
						? ((a = "function" == typeof t ? t : jx(+t)), y)
						: a;
				}),
				(y.filter = function (t) {
					return arguments.length
						? ((r = "function" == typeof t ? t : jx(!!t)), y)
						: r;
				}),
				(y.touchable = function (t) {
					return arguments.length
						? ((u = "function" == typeof t ? t : jx(!!t)), y)
						: u;
				}),
				(y.extent = function (t) {
					return arguments.length
