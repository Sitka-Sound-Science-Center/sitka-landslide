...
export const page = {
  title: "Areas at risk",
  description: "Learn more about which parts of Sitka are most exposed to debris flows",
};
...
- The likelihood that if a landslide occurred, that the material would travel or deposit material in a given location.
...
The following map uses Terrainworks NetMap [Slope Stability analysis](https://terrainworks.com/slope-stability) tool and is included in the [Landslide and Debris Flow Potential in Southeast Alaska](https://terrain-works.maps.arcgis.com/apps/Cascade/index.html?appid=679cadeb7c304edc8fc121d125e95871) storymap. The map was contacted by the US Forest Service.
