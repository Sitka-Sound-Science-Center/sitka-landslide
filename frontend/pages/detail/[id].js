...
export async function getStaticProps({ params }) {
  ...
  return {
    props: { historicalData, detailData },
  };
}

export default function Home({ historicalData, detailData }) {
  ...
  return (
    <div className={styles.container}>
      ...
      <main className={styles.main}>
        <p>
          The amount of <strong>rainfall over a 3 hour period</strong> is a
          strong indicator of whether a landslide will occur. Here, each circle
          represents a day in Sitka over the past ten years and whether
          <span class="color color-red"></span>
          <strong>a major landslide occurred</strong> or
          <span class="color color-gray"></span>
          <strong>no landslide occurred</strong>.
        </p>
        <div id="chart">
